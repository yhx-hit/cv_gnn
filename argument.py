import argparse
# python gnn-main.py --data_root 'cvdata' --nway 4 --shots 15 --save
def parser():
    ...
    parser.add_argument('--max_iteration', default=3100, type=int, help='max iteration to train')
    ...
    parser.add_argument('--data_root', default='cvdata', help='root for train data')
    ...
    parser.add_argument('--nway', default=4, type=int)
